      ...
      {attempting && !hash && (
        <LoadingView onDismiss={wrappedOnDismiss}>
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>{parsedAmount?.toSignificant(4)} CROAK</TYPE.body>
          </AutoColumn>
        </LoadingView>
      )}
      {attempting && hash && (
        <SubmittedView onDismiss={wrappedOnDismiss} hash={hash}>
          ...
          <AutoColumn gap="12px" justify={'center'}>
            ...
            <TYPE.body fontSize={20}>Staked {parsedAmount?.toSignificant(4)} CROAK</TYPE.body>
...
function AddXDiffButton({ addToken, success }: { addToken: () => void; success?: boolean }) {
  ...
  return <ButtonSecondary onClick={addToken}>Add xCROAK to Metamask</ButtonSecondary>
}
